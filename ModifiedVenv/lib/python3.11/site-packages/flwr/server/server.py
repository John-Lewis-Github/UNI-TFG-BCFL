...
def run_fl(
    ...
    print(f"{hist.metrics_centralized = }")

    global_accuracy_centralised = hist.metrics_centralized["cen_accuracy"]
    round = [data[0] for data in global_accuracy_centralised]
    acc = [100.0 * data[1] for data in global_accuracy_centralised]
    #global_loss_centralised = hist.metrics_centralized['cen_loss']
    #loss = [100.0 * data[1] for data in global_loss_centralised]
    matplotlib.use('agg')
    plt.plot(round, acc)
    #plt.plot(round, acc, "-b", label="accuracy")
    #plt.plot(round, loss, "-r", label="loss")
    #plt.legend(loc="upper left")
    plt.grid()
    plt.ylabel("Accuracy (%)")
    plt.xlabel("Ronda")
    plt.xticks(range(0,len(round)))
    plt.title("MNIST - IID - 17 clientes con 5 clientes por ronda")
    base_path = os.path.dirname(os.path.abspath(__file__))
    file_name = "/../../../../../../bcfl/bcfl/resultados.png" ## your path variable
